		          						  	...
		          						  	<center> 
		          						    	...
		          						    	<div class="modal-content">
		          						      		...
		          						      		<div class="modal-body">
		                                         						      			<div class="row">
		                                         						      			<div class="col-lg-6">
		          						      			<a href="/binaries/wallet/0.4.15/BitSharesX-0.4.15-a-x86.exe" class=" btn btn-default bolt-button-dark" style="">BitsharesX (x86)<span class="ion-social-windows"  style="font-size: 18px;"></span></a>
		          						      			</div>
		          						      			<div class="col-lg-6">
		          						      			<a href="/binaries/wallet/0.4.15/BitSharesX-0.4.15-a-x64.exe" class="btn btn-default bolt-button-dark" >BitsharesX (x64)<span class="ion-social-windows" style="font-size: 18px;"></span></a>
		          						      			</div>
		          						      			<div class="col-lg-12">
